...
SCENARIOS = {
    '🛡️ 기본': {
        'desc': '부족 1주 / 목표 4주 — 결품 임박 시 4주까지 충전. 소액 사이즈도 결품이면 보충(매출 회복 극대). 이동 상한: 각 채널 현재고의 50%',
...
def render_channel_tab():
    ...
    for r in results_ch:
        d = r['data']
        o = g_ord(d); i = g_inv(d); mv = g_move(r)
    ...
    if data:
        ...
        styled = (df_ch.style
                  ...
                  .format({'일평균판매': '{:.1f}'.format, '효과(만원)': '{:,}'.format}))
